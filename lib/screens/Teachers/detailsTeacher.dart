              ...
              children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(widget.teacher.name, maxLines: 1, overflow: TextOverflow.ellipsis, 
                        style: TextStyle(color: textColor, fontSize: 16, fontWeight: FontWeight.w600),
                      ),
                      SizedBox(height: 10,),
                      Text(widget.teacher.email, style: TextStyle(fontSize: 14, color: textColor),),
                      SizedBox(height: 10,),
                      Row(
                        children: [
                          Icon(Icons.local_activity_sharp, color: labelColor, size: 14,), 
                          SizedBox(width: 2,),
                          Text(widget.teacher.country, style: TextStyle(fontSize: 12, color: labelColor),),
                          SizedBox(width: 20,),
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 2,),
                          Text(widget.teacher.phone, style: TextStyle(fontSize: 12, color: labelColor),),
                          SizedBox(width: 20,),
                          Icon(Icons.star, color: orange, size: 14,), 
                          SizedBox(width: 2,),
                          Text(widget.teacher.rate.toString(), style: TextStyle(fontSize: 12, color: labelColor),)
                        ],
                      ),
                ...
                SizedBox(height: 10,),
                Text(widget.teacher.intro, maxLines: 2, overflow: TextOverflow.ellipsis, 
